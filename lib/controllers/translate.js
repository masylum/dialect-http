module.exports = function (DIALECT_HTTP) {
  ...
  app.get('/:locale/ok', authenticate, function (req, res) {
    var funk = require('funk')(),
        results_per_page = 30,
        locale = req.param('locale'),
  ...
  // TODO: Refactor!! DRY a little bit
  app.get('/:locale/pending', authenticate, function (req, res) {
    var funk = require('funk')(),
        results_per_page = 30,
        locale = req.param('locale'),
  ...
  // TODO: Refactor!! DRY a little bit
  app.get('/:locale/missing', authenticate, function (req, res) {
    var funk = require('funk')(),
        results_per_page = 30,
        locale = req.param('locale'),
