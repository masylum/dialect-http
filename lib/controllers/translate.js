module.exports = function (DIALECT_HTTP) {
  ...
  // TODO: Refactor!! DRY a little bit
  app.get('/:locale/ok/:page?', authenticate, function (req, res) {
    var results_per_page = 30,
        locale = req.param('locale'),
        query = {locale: locale, translation: {'$ne': null}, approved: true},
        authorized_locales = app.dynamicViewHelpers.authorized_locales(req, res),
        check_locale = function (el) {
          return el === locale;
        };
  ...
  // TODO: Refactor!! DRY a little bit
  app.get('/:locale/pending/:page?', authenticate, function (req, res) {
    var results_per_page = 30,
        locale = req.param('locale'),
        query = {locale: locale, translation: {'$ne': null}, approved: false},
        authorized_locales = app.dynamicViewHelpers.authorized_locales(req, res),
        check_locale = function (el) {
          return el === locale;
        };
  ...
  // TODO: Refactor!! DRY a little bit
  app.get('/:locale/missing/:page?', authenticate, function (req, res) {
    var results_per_page = 30,
        locale = req.param('locale'),
        query = {locale: locale, translation: null},
        authorized_locales = app.dynamicViewHelpers.authorized_locales(req, res),
        check_locale = function (el) {
          return el === locale;
        };
